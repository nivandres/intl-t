...
`@intl-t/react` provides lightweight React bindings for [intl-t](https://www.npmjs.org/package/intl-t): a provider, typed useTranslation hook, and component-safe variable injection so you can render translations and rich content with full TypeScript safety.

[**→ Check out the Intl-T Website**](https://intl-t.dev)

[![npm version](https://img.shields.io/npm/v/@intl-t/react.svg?label=@intl-t/react)](https://www.npmjs.com/package/intl-t)
