...
`@intl-t/locales` provides locale typing and helpers shared across intl-t packages, ensuring consistent ISO codes and metadata when negotiating and formatting languages.
